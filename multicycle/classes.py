...
def on_line_click():
    print("Line clicked!")
Fetch = {71,21, 0, 6, 7, 101, 101, 7, 8, 55, 58, 59, 59, 61, 80, 63, 82, 82, 83, 83, 84, 84, 84, 85, 85, 85, 9,81,1,15,16,17,73,86,103}
Decode = {8, 39, 7, 28, 29, 61, 6, 37, 9,  27, 25, 24, 59,58,49,50,34,35}
R_type1 = {52, 54, 51,  58, 59, 56, 53, 61,57}
R_type2 = {44,43,60,23,22,14,65,46,21,70}
I_type = {51,57,56,58,24,25,30,31,32,33,59,61}
I_type_2 =[60,42,41,37,22,14,65,181,125,123,172,148,23,21,46,70,23,22,22,21,46,60]
lw1 = {63,64,13,12,10,15,65,14,11,10,103}
lw2 = {17,18,19,20,41,42,46,70,37,60}
Sw = {13,12,52,53,69,68,67,66,14,10,11,15,63,64,65,102}
...
Jal =  {34, 92, 91, 89, 73, 0, 2, 4, 5, 70, 47, 48,88,90,3,46,82,83,84,85,86,71,34,60}
